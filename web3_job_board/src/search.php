...
<div class = "header">
    ...
    <div class = "container" id = "search-container">
        <div class = "typewriter">
            <h1 id = "welcome-text"><span id ="search-text">search </span>for a role.</h1>
        </div>

        <div id = "search-box">
            <form name = "search-form" onsubmit = "return validateForm()" action = "search-results.php?" method = "GET">

                <div id = "company-search">
                    <label for= "company-id">Company:</label>
                    <input type = "text" class = "form-control" id = "company-id" name = "company">
                </div>
    ...
    <script>
        function validateForm() {
            ...
            let salary = document.forms["search-form"]["salary"].value;
